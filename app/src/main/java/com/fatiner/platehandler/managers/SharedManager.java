...
public class SharedManager {
    ...
    public static boolean getBoolean(Context context, String name, String key) {
        return getPreferences(context, name).getBoolean(key, SharedGlobals.DF_BOOL);
    }

    public static int getInt(Context context, String name, String key) {
        return getPreferences(context, name).getInt(key, SharedGlobals.DF_INT);
    }

    public static String getString(Context context, String name, String key) {
        return getPreferences(context, name).getString(key, SharedGlobals.DF_STRING);
    }
